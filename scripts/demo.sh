...
# go run ./cmd/profiler --submit-log experiments/_raw/demo.jsonl --out experiments/_raw/demo.csv &

echo "[5/8] loadgen: steady + burst"
# go run ./cmd/loadgen --arrival burst --qps 20 --duration 90s --out experiments/_raw/demo.jsonl
