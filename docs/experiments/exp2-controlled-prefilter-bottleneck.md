# Exp2 Extension — Forcing the PreFilter Full-Cluster Scan
...
[Exp2 TopoGang load profiling](exp2-topogang-load-profiling.md). This document is
...
4. Use `scripts/exp2-topogang-prefill.sh` to create filler Pods for the target `ρ`.
