...
| 7 | Exp1 full sweep + Exp2 gang comparison | Scale sweep + gang-vs-default results | 🔲 Planned |
| 8 | Exp3 burst scale-out + API-server pressure | Burst load results | 🔲 Planned |
| 9 | Results compilation, charts, dashboard, CI | Generated figures + dashboard | 🔲 Planned |
| 10 | README, demo, resume, interview, upstream | Full deliverables + write-up | 🔲 Planned |

**Latest:** Day 1 stood up a Docker-runtime kwok cluster, scaled the fake GPU pool to **2,000 nodes (all Ready in ≤ 3 s incrementally)**, and wired Prometheus scraping of API-server / scheduler metrics. → [Read Day 1](Day-01-KWOK-Environment-and-SLOs.md)
...
| 7 | [Day 7 — Exp1 sweep + Exp2 gang](Day07.md) |
| 8 | [Day 8 — Exp3 burst scale-out](Day08.md) |
| 9 | [Day 9 — Charts, dashboard, CI](Day09.md) |
