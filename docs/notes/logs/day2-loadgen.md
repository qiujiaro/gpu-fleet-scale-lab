# Day 02 — Load Generator v0 (`client-go`)
...
## Exp3 client calibration preflight
...
go run ./cmd/loadgen \
  ...
  --out experiments/day2-client-preflight/run.jsonl
```
...
- `experiments/day2-client-preflight/run.jsonl`
- `experiments/day2-client-preflight/loadgen.log`
- `experiments/day2-client-preflight/summary.csv`
