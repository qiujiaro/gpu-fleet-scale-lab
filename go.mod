module github.com/qiujiaro/gpu-fleet-scale-lab
...
// Day 4: pinning k8s.io/kubernetes forces every k8s.io/* staging repo to the matching
// v0.30.0. The main module publishes them as v0.0.0 placeholders, so without these
// replaces the build fails with "unknown revision v0.0.0". Mirrored from
// https://github.com/kubernetes-sigs/scheduler-plugins/blob/master/go.mod (release-1.30).
replace (
